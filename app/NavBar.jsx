...
function NavBar() {
  ...
  return (
    <nav className="md:flex md:justify-center md:items-center md:space-x-6 md:border-solid md:border-2 md:border-slate-100 md:rounded md:m-4 p-2 sticky shadow-md">
