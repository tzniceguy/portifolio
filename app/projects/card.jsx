...
export default function Card() {
  return (
    <div class="rounded-lg border bg-card text-card-foreground shadow-sm" data-v0-t="card">
        <div class="p-4">
            <Image src="/placeholder.svg" width="300" height="150" alt="Project" class="aspect-[2/1] overflow-hidden rounded-lg object-cover object-center">
            </Image>
        </div>
        <div class="flex flex-col space-y-1.5 p-4">
            <h3 class="whitespace-nowrap tracking-tight text-lg font-medium">
            Project One</h3>
            <p class="text-muted-foreground text-sm"> A brief description of the project.</p>
        </div>
